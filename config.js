...
global.owner = process.env.OWNER_NUMBER || "2347072160127"; // owner number , for multiple number
global.sudo = process.env.SUDO  || "";
global.ownername = process.env.OWNER_NAME || "Virus Tech"; //set bot owner name here 
global.botname = process.env.BOT_NAME || "𝚅𝙸𝚁𝚄𝚂-𝙼𝙳"
global.author = process.env.AUTHOR  || "Virus Tech";
global.packname = process.env.PACK_NAME  || "© 𝚅𝙸𝚁𝚄𝚂 ᴍᴅ ²⁶";
global.session = process.env.SESSION_ID || ""
global.timezone = process.env.TIME_ZONE || "Africa/Lagos";
global.simbol = process.env.SYMBOL || '💀';
global.thumb = process.env.THUMB || "thehttps://files.catbox.moe/lkojib.jpg"
global.footer = process.env.FOOTER || '';
global.warn = process.env.WARN || '4'
global.menutype = process.env.MENU_TYPE || ''
global.scan = 'https://virus-md.vercel.app'
